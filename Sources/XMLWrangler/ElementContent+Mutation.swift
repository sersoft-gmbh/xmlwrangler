extension RangeReplaceableCollection where Self: MutableCollection, Element == XMLElement.Content {
    ...
    public mutating func compress() {
        ...
        while let nextIndex = index(currentIndex, offsetBy: 1, limitedBy: endIndex) {
